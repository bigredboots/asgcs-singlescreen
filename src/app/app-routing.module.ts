...
import { DemandComponent } from './pages/demand/demand/demand.component';
...
import { OutboundComponent } from './pages/outbound/outbound/outbound.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    data: { title: '22Main Page', breadcrumb: '' },
  },
  {
    path: 'outbound',
    component: OutboundComponent,
    data: { title: '23Main Page', breadcrumb: '' },
  },
